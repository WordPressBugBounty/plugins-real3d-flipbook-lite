    ...
    $(document).on("click", ".r3d-pro-content", function (e) {
      ...
      Swal.fire({
        ...
        html:
          ...
          '<a style="font-size:12px;color:#2271b1;" href="https://real3dflipbook.com/?utm_source=wp-lite&utm_medium=plugin&utm_campaign=upgrade&utm_content=popup-editor" target="_blank">See live demos</a>' +
          '</div>',
        ...
        if (result.isConfirmed) {
          window.open(
            "https://real3dflipbook.com/lite-vs-pro/?utm_source=wp-lite&utm_medium=plugin&utm_campaign=upgrade&utm_content=popup-editor",
            "_blank"
          );
        }
      });
