...
<div id='real3dflipbook-admin' style="display:none;">
	...
	<div>
		<h2 id="r3d-tabs" class="nav-tab-wrapper wp-clearfix">
			...
			<a href="#" class="nav-tab" data-tab="tab-menu"><?php esc_html_e('Toolbar', 'real3d-flipbook'); ?></a>
			<?php
			?>
		...
		<div id="tab-menu" style="display:none;">
			<div class="meta-box-sortables">
				<h3><?php esc_html_e('Toolbar buttons', 'real3d-flipbook'); ?></h3>

				<table class="widefat r3d-mb-table">
					<thead>
						<tr>
							<th class="r3d-mb-drag"></th>
							<th><?php esc_html_e('Button', 'real3d-flipbook'); ?></th>
							<th><?php esc_html_e('Enabled', 'real3d-flipbook'); ?></th>
							<th><?php esc_html_e('Title', 'real3d-flipbook'); ?></th>
							<th><?php esc_html_e('Position', 'real3d-flipbook'); ?></th>
							<th></th>
						</tr>
					</thead>
					<tbody id="r3d-menu-buttons-tbody"></tbody>
				</table>

				<div id="r3d-mb-source" style="display:none;">
					<?php
				...
				<script>
					var r3dMenuButtons = [
						{ name: 'currentPage', title: '<?php echo esc_js(__('Current page', 'real3d-flipbook')); ?>' },
						{ name: 'btnPrev', title: '<?php echo esc_js(__('Previous page', 'real3d-flipbook')); ?>' },
						{ name: 'btnNext', title: '<?php echo esc_js(__('Next page', 'real3d-flipbook')); ?>' },
						{ name: 'btnZoomIn', title: '<?php echo esc_js(__('Zoom In', 'real3d-flipbook')); ?>' },
						{ name: 'btnZoomOut', title: '<?php echo esc_js(__('Zoom Out', 'real3d-flipbook')); ?>' },
						{ name: 'btnToc', title: '<?php echo esc_js(__('Table of Contents', 'real3d-flipbook')); ?>' },
						{ name: 'btnThumbs', title: '<?php echo esc_js(__('Thumbnails', 'real3d-flipbook')); ?>' },
						{ name: 'btnShare', title: '<?php echo esc_js(__('Share', 'real3d-flipbook')); ?>' },
						{ name: 'btnPrint', title: '<?php echo esc_js(__('Print', 'real3d-flipbook')); ?>' },
						{ name: 'btnDownloadPdf', title: '<?php echo esc_js(__('Download PDF', 'real3d-flipbook')); ?>' },
						{ name: 'btnSound', title: '<?php echo esc_js(__('Sound', 'real3d-flipbook')); ?>' },
						{ name: 'btnExpand', title: '<?php echo esc_js(__('Fullscreen', 'real3d-flipbook')); ?>' },
						{ name: 'btnTools', title: '<?php echo esc_js(__('Tools', 'real3d-flipbook')); ?>' },
						{ name: 'btnClose', title: '<?php echo esc_js(__('Close', 'real3d-flipbook')); ?>' }
					];
					
					var r3dProMenuButtons = [
						{ name: 'btnFirst', title: '<?php echo esc_js(__('First page', 'real3d-flipbook')); ?>' },
						{ name: 'btnLast', title: '<?php echo esc_js(__('Last page', 'real3d-flipbook')); ?>' },
						{ name: 'btnAutoplay', title: '<?php echo esc_js(__('Autoplay', 'real3d-flipbook')); ?>' },
						{ name: 'btnDownloadPages', title: '<?php echo esc_js(__('Download pages', 'real3d-flipbook')); ?>' },
						{ name: 'btnSingle', title: '<?php echo esc_js(__('Toggle Single Page', 'real3d-flipbook')); ?>' },
						{ name: 'btnSearch', title: '<?php echo esc_js(__('Search Button', 'real3d-flipbook')); ?>' },
						{ name: 'search', title: '<?php echo esc_js(__('Search Input', 'real3d-flipbook')); ?>' },
						{ name: 'btnBookmark', title: '<?php echo esc_js(__('Bookmark', 'real3d-flipbook')); ?>' }
					];
